defmodule FuelynxWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FuelynxWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FuelynxWeb.Gettext, "errors", msg, opts)
    end
  end
